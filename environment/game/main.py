    ...
    def get_reward(self, player):
        if len(self.memoire) <= 1:
            ...
            if self.memoire[-1][player][1] != self.memoire[-2][player][1]:
                ...
                distm1, distm2 = [sqrt((self.memoire[-i][player][2]-self.carte_cp[self.memoire[-i][player][1]][0])**2 + (self.memoire[-i][player][3]-self.carte_cp[self.memoire[-i][player][1]][1])**2) for i in range(1, 3)]
